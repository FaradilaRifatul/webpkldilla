...
<body style="background-color:beige; padding-left:30%">
    <div class="container mt-5">
        <h2 style="margin-left: 17%;">Checkout</h2>
        <form>
            <div class="row">
                <div class="col-md-6">
...
{{--
            <button type="submit" class="btn btn-danger mt-3">Konfirmasi Pembayaran</button> --}}
            <a href="/sukses" class="btn btn-danger" style="margin-left:15%">Konfirmasi Pembayaran</a>
                </form>
